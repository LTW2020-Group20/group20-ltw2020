      ...
      <div class="col-sm-4" style="margin-left: 35%">
        <div class="signup-form" style="margin-bottom: 50px;margin-top: 20px">
          ...
          <form action="<%=Util.fullPath("Edit")%>" method="post">
            ...
            <input style="height: 30px; color: black" type="text" id="name" name="name" placeholder="User name..." value="<%=user.getString(2)%>"/><br>
            ...
            <input style="height: 30px;color: black" type="text"  name="phone" placeholder="Your number..." value="<%=request.getAttribute("phone") != null ? request.getAttribute("phone") : user.getString(5)%>"/>

              <%--@declare id="pwd"--%><label class="control-label col-sm-3 m" for="pwd">Email</label>
              <input style="height: 30px;color: black" type="email"  name="email" placeholder="Your email..." value="<%=request.getAttribute("email") != null ? request.getAttribute("email") : user.getString(4)%>"/>

              <%--@declare id="pwd"--%><label class="control-label col-sm-3 m" for="pwd">Address</label>
              <input style="height: 30px;color: black" type="text"  name="address" placeholder="Your address..." value="<%=request.getAttribute("address") != null ? request.getAttribute("address") : user.getString(7)%>"/>
