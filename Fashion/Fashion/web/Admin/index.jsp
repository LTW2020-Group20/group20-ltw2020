...
<div class="wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item" ><a href="/doLogout">Logout</a></li>
              <%
                } else{
              %>
        ...
        <div class="row">
          ...
          <section class="col-lg-5 connectedSortable">
            ...
            <div class="card bg-gradient-primary">
              <div class="card-header border-0" style="background-color: #077fff">
                <h3 class="card-title">
                ...
                <div class="card-tools">
                  <button type="button"
                          ...
                          data-toggle="tooltip"
                          title="Date range" style="background-color: #077fff">
                  ...
                  <button type="button"
                          ...
                          data-toggle="tooltip"
                          title="Collapse" style="background-color: #077fff">
              ...
              <!-- /.card-body-->
              <div class="card-footer bg-transparent" style="background-color: darkslategrey">
                <div class="row">
  ...
  <footer class="main-footer">
    <strong>Group 20 - LTW 2020 <a href="#">Admin Page</a>.</strong>
    All we make.
  </footer>
