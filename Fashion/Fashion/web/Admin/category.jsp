...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    font-weight: bolder;">All of the category</i>

            </div>
            <a href="<%= Util.fullPath("add_category")%>"> <i  style="color: dodgerblue ; font-size: 20px; float: right; margin: 6px"class="fas fa-plus"></i></a>
          ...
          <%--            <a href="<%= Util.fullPath("countau")%>"> <i  style="color: dodgerblue ; font-size: 20px; float: right; margin: 6px"class="fas fa-plus"></i></a>--%>
            ...
            <div class="card-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                <%
                  ResultSet theloai= (ResultSet) request.getAttribute("theloai");
                  while(theloai.next()){
                %>
                <tr>
                  <td><%= theloai.getInt(1)%></td>
                  <td><%= theloai.getString(2)%></td>

                  <td><img src="<%=theloai.getString(3)%>" style="height: 100px;width: auto"> </td>
                  <td>                    <i style=" color: limegreen; font-size: 20px" class="fa fa-check" > </i>
                  </td>
                  <td>
                    <a onclick="" href="<%=Util.fullPath("dellctg?id=")+theloai.getInt(1)%>">  <i  style="color: red ; font-size: 20px; float: right; margin: 6px"class="fas fa-trash"></i></a>
                    <a href="<%=Util.fullPath("checkctg?id="+theloai.getInt(1))%>"> <i  style="color: orange ; font-size: 20px; float: right; margin: 6px"class="fas fa-pencil-alt"></i></a>
                  </td>
