...
<%--          </li>--%>
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/webbook/listReceipt" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
...
<%--              <h3 class="card-title">DataTable with minimal features & hover style</h3>--%>
            ...
            <a href="<%= Util.fullPath("counttype")%>"> <i  style="color: dodgerblue ; font-size: 20px; float: right; margin: 6px"class="fas fa-plus"></i></a>
...
<%--                  <td><%= rs.getString(6)%></td>--%>
                  <td>
                 <a onclick="" href="<%=Util.fullPath("deletetype?name=")+rs1.getString(2)%>">  <i  style="color: red ; font-size: 20px; float: right; margin: 6px"class="fas fa-trash"></i></a>
<%--                    <a href="<%=Util.fullPath("updateuser?name="+rs1.getString(1))%>"> <i  style="color: dodgerblue ; font-size: 20px; float: right; margin: 6px"class="fas fa-pencil-alt"></i></a>--%>
                  </td>
