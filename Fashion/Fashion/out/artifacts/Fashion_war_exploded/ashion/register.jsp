        ...
        <div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55" style="height: 585px">
            <form class="login100-form validate-form flex-sb flex-w">
                ...
                <div class="wrap-input100 validate-input m-b-12">
                    ...
                    <input class="input100" type="username" name="user" style="height: 44px;">
                ...
                <div class="wrap-input100 validate-input m-b-12" data-validate = "Email is required">
                    ...
                    <input class="input100" type="email" name="email"  style="height: 44px;">
                    <span class="focus-input100"></span>
                </div>
                <span class="txt1 p-b-11">
						Password
                ...
                <div class="wrap-input100 validate-input m-b-12">
                    ...
                    <input class="input100" type="phone" name="pass" style="height: 44px;">
                    <span class="focus-input100"></span>
                </div>
